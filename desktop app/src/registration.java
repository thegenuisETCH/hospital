...
public class registration {
    ...
    public void registration(final Stage registerationStage) {

        registerationStage.setTitle("Registration");
        ...
        btn_1.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                obj_patient.patient(registerationStage);
            }
        });
        ...
        btn_2.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                obj_clinic.clinic(registerationStage);
            }
        });
        ...
        btn_3.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                obj_emergency.emergency(registerationStage);
            }
        });
        ...
        btn_4.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                obj_room.room(registerationStage);
            }
        });
        ...
        btn_5.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                obj_money.money(registerationStage);
            }
        });
        ...
        btn_6.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                lap obj_lap = new lap();
                obj_lap.lap(registerationStage);
            }
        });
        ...
        btn_7.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                obj_registration.registration(registerationStage);
            }
        });
        ...
        registerationStage.setScene(new Scene(root, 500, 350));
        registerationStage.setFullScreen(true);
